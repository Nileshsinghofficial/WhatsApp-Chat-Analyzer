...
st.sidebar.markdown('<b>Nilesh Singh</b>\
                <a href = "https://github.com/nileshsinghofficial/WhatsApp-Chat-Analyzer/" ><img src = "https://img.shields.io/badge/Author-@Nileshsinghofficial-gray.svg?colorA=gray&colorB=dodgerblue&logo=github"/>\
...
if filename is not None:
    ...
    try:
        ...
        member = st.sidebar.selectbox("Member Name", names, key='1')
          ...
          # New: Word to analyze
        word_to_analyze = st.sidebar.text_input("Enter a word to analyze in messages:", "")
        ...
        if not st.sidebar.checkbox("Hide", True):
            try:
                if member == "All":
                    ...
                    st.markdown(analysis.stats(data, word=word_to_analyze), unsafe_allow_html=True)
                    ...
                    st.markdown(analysis.stats(member_data,word=word_to_analyze),
...
st.sidebar.markdown(
    "[![built with love](https://forthebadge.com/images/badges/built-with-love.svg)](https://www.linkedin.com/in/nileshsinghofficial/)")
st.sidebar.markdown(
    "[![smile please](https://forthebadge.com/images/badges/makes-people-smile.svg)](https://www.linkedin.com/in/nileshsinghofficial/)")
